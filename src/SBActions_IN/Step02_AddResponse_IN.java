...
public class Step02_AddResponse_IN {
	...
	//Filling responser details
		...
		@FindBy (xpath = "//div[@class='bx--list-box__menu-item__option' and contains(text(), 'India')]") private WebElement  Citizenship_list ;
//		@FindBy (id= "FLD_CAND_GID") private WebElement GID;
//		@FindBy (id ="FLD_CAND_REF_NUM") private WebElement reference;
		@FindBy (xpath= "//*[@id='cdk-accordion-child-4']/div/div[8]/div/input") private WebElement GID;
		@FindBy (xpath= "//*[@id='cdk-accordion-child-4']/div/div[9]/div/input") private WebElement reference;
		@FindBy (xpath= ".//*[@id='cdk-accordion-child-4']/div/div[9]/div/span") private WebElement lbl_Request_No;
...
//		@FindBy (xpath= "//mat-calendar[contains(@id,'mat-datepicker')]/div/mat-month-view/table/tbody/tr[4]/td[5]") private WebElement enddt_Calender;
		...
		@FindBy (xpath= "//div[@class='bx--list-box__menu-item__option' and contains(text(),'0-1 Year')]") private WebElement skill_lvl_drpdown;
	...
	//Submit response
		...
		public void login() throws IOException, InterruptedException{
			...
			Username_box.clear();
			Username_box.sendKeys(Excel.getCellValue(xlsFilePath, sheet, 14, 0));
			continue_btn.click();
			Thread.sleep(1000);
			Password_Box.clear();
			Password_Box.sendKeys(Excel.getCellValue(xlsFilePath, sheet, 14, 1));
		...
		public void openRequest() throws InterruptedException
		{
			...
			System.out.println(
					"searched and Opened the request " + Excel.getCellValue(xlsFilePath, "Request_creation", 3, 15));
			//wait given
			Search_btn.click();
...
//			Thread.sleep(5000);
		...
		public void resDetails(String First_Name_temp , String Middle_Name_temp , String LastName_Surname_temp, String Refernce_Num) throws IOException, InterruptedException 
